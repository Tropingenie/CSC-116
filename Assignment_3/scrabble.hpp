...
//Since my solution uses unordered maps, I have typedef'ed the following line - B.Lyne
...
private:
    ...
    UnorScoreMap dictionary_map {};//stores the dictionary as a std::unordered_map
};
