...
int main(){
    ...
    try{
		...
		*
		* Post-testing: Turns out these "special matrices" are called singular matrices! Of course, I'm a nonce and there was a
		* typo in the code. Welp, there's always the resubmission.
        */
